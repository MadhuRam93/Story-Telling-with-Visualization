...
function Draw11(){
	...
	changeTopText(newText = "The yellow arc represents team players under CSK franchise.",
		loc = 0/2, delayDisappear = 0, delayAppear = 1, finalText = false, xloc=200, w=330);
			
	changeTopText(newText = "The different colored chords represent players who moved into CSK from other franchisees in 2014.",
		loc = 0/2, delayDisappear = 7, delayAppear = 8, finalText = true, xloc=180, w=340);
